...
// validationHandler(),
controllerAdapter_1.default(RecipeController_1.default, "search"));
...
controllerAdapter_1.default(RecipeController_1.default, "create"));
//   router.route("/create").post(
...
// (req, res) => console.log('hhhhhhhhhhhhhhhhhhhhhhhh'),
controllerAdapter_1.default(RecipeController_1.default, "update"));
